...
seq_record_list = get_protein_sequences(home_dir=home_dir, max_seq_len=1022, return_type="seq_record_list", data_type=pathogenicity_type)


model_name = "sequnet"
model = model_utils.get_model()
model_task_out_dir, model_logits_out_dir = model_utils.create_output_directories(model_name=model_name, task=pathogenicity_type)

def execute(seq_record_list, analysis_no=0):
