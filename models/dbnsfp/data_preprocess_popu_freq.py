...
variants_df[["chrom", "chrom_pos", "ref_allele", "alt_allele"]].to_csv(f"models/dbnsfp/datasets_population_freq/SNVs_with_popu_freq_balanced_chromosomal.txt", index=False, sep=" ", header=False)
