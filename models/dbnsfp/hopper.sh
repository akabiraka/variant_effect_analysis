...
#SBATCH --output=/projects/ashehu/akabir4/projects/variant_effect_analysis/argo_logs/pmd-%j.out
#SBATCH --error=/projects/ashehu/akabir4/projects/variant_effect_analysis/argo_logs/pmd-%j.err
