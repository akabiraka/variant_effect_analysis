...
java -cp data/dbnsfp/dbNSFP43a/ search_dbNSFP43a -i models/dbnsfp/datasets_pmd/PMD_chromosomal.txt -o models/dbnsfp/outputs/pmd_preds.txt -w 1-6,77,90,38,44,47,118,83 
