...
model_name = "prottrans_xlnet_uniref100" # prottrans_t5_xl_u50, prottrans_bert_bfd, plus_rnn
...
if __name__ == "__main__":
    ...
    protid_mutpos_df = variants_df[["prot_acc_version", "prot_pos"]].drop_duplicates(keep="first") # prot_id_mutpos_seq_df
