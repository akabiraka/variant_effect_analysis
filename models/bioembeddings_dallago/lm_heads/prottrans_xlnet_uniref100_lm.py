...
class ProtTransXLNetUniRef100LM(EmbedderInterface):
    ...
    number_of_layers = 1
    _model: XLNetLMHeadModel
    _model_fallback: Optional[XLNetLMHeadModel]
    ...
    def __init__(self, **kwargs):
        ...
        self._model = (
            XLNetLMHeadModel.from_pretrained(self.model_directory, mem_len=512)
            .to(self._device)
            .eval()
        )
